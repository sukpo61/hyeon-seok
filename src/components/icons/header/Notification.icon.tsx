...
import { newNotificationCountRecoil } from 'src/recoil-states/newNotificationState';
...
export const NotificationIcon = ({ styles }: NotificationIconProps) => {
    const notificationCount = useRecoilValue(newNotificationCountRecoil);
                    ...
                    <>
                        ...
                        {notificationCount > 10 && (
                            <text
                                ...
                                // 각각의 OS 상 에서 폰트 호환 필요
                                style={{
                                    font: `bold 10px sans-serif,monospace`,
                                    fill: `#fff`,
                                }}
                            >
                                {'+'}
